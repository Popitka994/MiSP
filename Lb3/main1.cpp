...
SUITE(EncryptTest)
{
    ...
    TEST(MaxShiftKey) {
        CHECK_EQUAL("SGDPTHBJAQNVMENWITLORNUDQSGDKZYXCNF",modAlphaCipher("Z").encrypt("THEQUICKBROWNFOXUMPSOVERTHELAZYDOG"));
    }
}
SUITE(DecryptText)
{
    ...
    TEST(MaxShiftKey) {
        CHECK_EQUAL("THEQUICKBROWNFOXJUMPSOVERTHELAZYDOG", modAlphaCipher("Z").decrypt("SGDPTHBJAQNVMENWTLORNUDQSGDKZYXCNF"));
    }
}
